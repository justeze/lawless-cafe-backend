...
menuRouter.post('/', uploadBridge.singleUpload, productMiddleware, menuController.postMenu)
menuRouter.patch('/', uploadBridge.singleUpload, menuController.patchMenu)
